...
public class Alumni {
    ...
    public Alumni(Integer alumniId, String registerNo, String name, String email,
                  String mobile, String department, String batch,
                  String currentCompany, String designation, Integer experience,
                  String location, String skills, String linkedin,
                  String password, String availableForMentorship) {
